                        ...
                        <div className="row login-register-cover">
                            <div className="col-lg-4 col-md-6 col-sm-12 mx-auto">
                                <div className="text-center">
                                    ...
                                    <h2 className="mt-10 mb-5 text-brand-1">Mulai Gratis Hari Ini</h2>
                                    <p className="font-sm text-muted mb-30">Akses semua fitur secara gratis.</p>
                                ...
                                <form className="login-register text-start mt-20" action="#">
                                    ...
                                    <div className="login_footer form-group d-flex justify-content-between">
                                        <label className="cb-container">
                                            <input type="checkbox" />
                                            <span className="text-small">Setujui persyaratan dan kebijakan kami</span>
