                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h2 className="mb-10">Artikel</h2>
                                        <p className="font-lg color-text-paragraph-2">Dapatkan berita terupdate beserta tips</p>
                                    </div>
                        ...
                        <div className="post-loop-grid">
                            <div className="container">
                                <div className="text-left">
                                    <h2 className="section-title mb-10 wow animate__animated animate__fadeInUp">Artikel Terbaru</h2>
                                    <p className="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Jangan Lewatkan artikel Trending</p>
                                </div>
                                <div className="row mt-30">
                                    ...
                                    <div className="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                                        ...
                                        <div className="sidebar-shadow sidebar-news-small">
                                            <h5 className="sidebar-title">Trending</h5>
