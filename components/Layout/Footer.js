            ...
            <div className="container">
                <div className="row">
                    <div className="footer-col-1 col-md-3 col-sm-12">
                        <Link legacyBehavior href="/"><a><img alt="jobBox" src="assets/imgs/template/logo.png" /></a></Link>
                        <div className="mt-20 mb-20 font-xs color-text-paragraph-2">FIF Group menyediakan sumber daya terbaik untuk menemukan dan terhubung kebutuhan pekerjaan di seluruh dunia.</div>
                    ...
                    <div className="footer-col-2 col-md-2 col-xs-6">
                        ...
                        <ul className="menu-footer">
                            ...
                            <li>
                                <a href="#">Tim Kami</a></li>
                            <li>
                                <a href="#">Products</a></li>
                            <li>
                                <a href="#">Hubungi Kami</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-col-6 col-md-3 col-sm-12">
                        ...
                        <p className="color-text-paragraph-2 font-xs">Unduh Aplikasi Mobile kami dan dapatkan Diskon ekstra 15%</p>
                        <div className="mt-15">
                ...
                <div className="footer-bottom mt-50">
                    <div className="row">
                        <div className="col-md-6"><span className="font-xs color-text-paragraph">Copyright © 2023. FIF Group all right reserved</span></div>
