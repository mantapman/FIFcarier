                ...
                <div className="container">
                    <div className="main-header">
                        <div className="header-left">
                            ...
                            <Link legacyBehavior href="/"><a className="d-flex"><img alt="jobBox" src="assets/imgs/template/logo.png" /></a></Link>
                            </div>
                        </div>
                        <div className="header-nav">
                            <nav className="nav-main-menu">
                                <ul className="main-menu">
                                    ...
                                    <li >
                                        <Link legacyBehavior href="/jobs-grid"><a>Vacancy</a></Link>

                                    </li>
                                    <li >
                                        <Link legacyBehavior href="/companies-grid"><a>Young Leader</a></Link>

                                    </li>
                                    <li>
                                        <Link legacyBehavior href="/candidates-grid"><a>Explore</a></Link>
                                    </li>
                                    ...
                                    <li >
                                        <Link legacyBehavior href="/blog-grid"><a>Artikel</a></Link>
                                    </li>
                                    <li>
                            ...
                            <div className="mobile-menu-wrap mobile-header-border">
                                ...
                                <nav>
                                    <ul className="mobile-menu font-heading">
                                        ...
                                        <li >
                                            <Link legacyBehavior href="/companies-grid"><a> FIF Young Leader</a></Link>
                                        </li>
                                        <li className="has-children">
